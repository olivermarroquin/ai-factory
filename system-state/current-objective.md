...
1. **Implement Guardian engine** — build `tools/guardian/run_guardian.py` that runs all four checks and emits the full JSON output defined in `docs/system-guardian-mvp-spec.md`.
